        ...
        <div class="column-7">
            ...
            <h2>Formulario de Inscripción de Profesores</h2>
                ...
                <label for="ID">Id del profesor:</label><br>
                    ...
                    <input type="text" id="nombre" name="nombre" value="<?php echo $resultados['nombre_profe']; ?>" onmouseleave="validaNombre()" >
                    <br>
                    <br>
                    <label for="apellidos">Apellido del profesor:</label><br>
                    <input type="text" id="apellidos" name="apellidos"  value="<?php echo $resultados['apellido_profe']; ?>" onmouseleave="validaApellidos()" >
                    <br>
                    <br>
                    ...
                    <input type="email" id="email" name="email"  value="<?php echo $resultados['email_profe']; ?>"onmouseleave="validaMail()">
                </div>
                <div class="campo">
                ...
                <select id="sexo" name="sexo" onclick="validaSexo()">
                    ...
                    <input type="tel" id="telefono" name="telefono" onmouseleave = "validaTelf()" value="<?php echo $resultados['telefono_profe']; ?>"><br>
                    <br>
                    ...
                    <input type="contrato" id="contrato" name="contrato"  value="<?php echo $resultados['fecha_contrato_profe']; ?>"onmouseleave="validaMail()"> <br><br>
                    <label for="nacimiento">Fecha de nacimiento:</label><br>
                    <input type="nacimiento" id="nacimiento" name="nacimiento"  value="<?php echo $resultados['fecha_nacimi_profe']; ?>"onmouseleave="validaMail()">
                </div>
                <label for="direccion" class="direccion">Dirección del profesor:</label><br>
                <input type="text" id="direccion" name="direccion" onmouseleave="validaDireccion()" value="<?php echo  $resultados['direccion_profe']; ?>">
